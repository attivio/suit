...
export SavedSearch from './api/SavedSearch';
...
export MetadataManager from './components/MetadataManager';
...
export SavedSearchRenderer from './components/SavedSearchRenderer';
